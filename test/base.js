...
describe("core", function () {
  ...
  it("add gauge & bribe rewards", async function () {
    ...
    expect(await gauge.rewardRate(ve_underlying.address)).to.not.equal(ethers.BigNumber.from(0));
    expect(await bribe.rewardRate(ve_underlying.address)).to.not.equal(ethers.BigNumber.from(0));
